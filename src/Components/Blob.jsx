...
const fragmentShader = `
  ...
  void main() {
    vec3 topColor = vec3(sin(uTime * 0.2) * 0.3, sin(uTime * 0.2) * 0.2 + 0.5, sin(uTime * 0.2) * 0.2 + 0.5);
    float timePhase = fract(uTime * 0.2);
    vec3 bottomColor = vec3(
      step(0.66, timePhase) + 
      step(0.33, timePhase) * step(timePhase, 0.66) * vec3(1.0, 1.0, 0.8) + 
      step(timePhase, 0.33) * vec3(0.53, 0.81, 0.92)
    );
